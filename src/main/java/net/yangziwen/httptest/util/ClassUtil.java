...
public class ClassUtil {
	...
	public static Type[] getSuperClassGenericTypes(Class clazz) {
		...
		if(!(genType instanceof ParameterizedType)){
			throw new IllegalStateException("No valid ParameterizedType exist!");
		}
	...
	public static Class getSuperClassGenericType(Class clazz, int index){
		...
		if(index < 0 || index >= params.length){
			throw new IllegalStateException("No valid ParameterizedType exist at the position of " + index + "!");
		}
